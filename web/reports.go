...
func (web *Web) rankingsPdfReportHandler(w http.ResponseWriter, r *http.Request) {
	...
	colWidths := map[string]float64{"Rank": 13, "Team": 20, "RP": 20, "Coop": 20, "Match": 20, "Auto": 20, "Barge": 20,
	...
	pdf.CellFormat(colWidths["Coop"], rowHeight, "QP", "1", 0, "C", true, 0, "")
	...
	for _, ranking := range rankings {
		...
		pdf.CellFormat(
			colWidths["Barge"], rowHeight, strconv.Itoa(ranking.EndgamePoints), "1", 0, "C", false, 0, "",
		)
